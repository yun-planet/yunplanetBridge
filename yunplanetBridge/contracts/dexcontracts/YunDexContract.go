...
const DexcontractsABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"_yunToken\",\"type\":\"address\"}],\"name\":\"config\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"myid\",\"type\":\"bytes32\"},{\"name\":\"result\",\"type\":\"string\"}],\"name\":\"__callback\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_from\",\"type\":\"address\"},{\"name\":\"_to\",\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"exChangeYUN\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"myid\",\"type\":\"bytes32\"},{\"name\":\"result\",\"type\":\"string\"},{\"name\":\"proof\",\"type\":\"bytes\"}],\"name\":\"__callback\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_from\",\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"},{\"name\":\"_token\",\"type\":\"address\"},{\"name\":\"_extraData\",\"type\":\"bytes\"}],\"name\":\"receiveApproval\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"fallback\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"from\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"to\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"uint256\"}],\"name\":\"Transfer\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"from\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"uint256\"},{\"indexed\":false,\"name\":\"token\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"extraData\",\"type\":\"bytes\"}],\"name\":\"Receive\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"code\",\"type\":\"uint256\"}],\"name\":\"mylog\",\"type\":\"event\"}]"
...
//
// Solidity: function config(_yunToken address) returns()
func (_Dexcontracts *DexcontractsTransactor) Config(opts *bind.TransactOpts, _yunToken common.Address) (*types.Transaction, error) {
	return _Dexcontracts.contract.Transact(opts, "config", _yunToken)
}

// Config is a paid mutator transaction binding the contract method 0x0e68ec95.
//
// Solidity: function config(_yunToken address) returns()
func (_Dexcontracts *DexcontractsSession) Config(_yunToken common.Address) (*types.Transaction, error) {
	return _Dexcontracts.Contract.Config(&_Dexcontracts.TransactOpts, _yunToken)
}

// Config is a paid mutator transaction binding the contract method 0x0e68ec95.
//
// Solidity: function config(_yunToken address) returns()
func (_Dexcontracts *DexcontractsTransactorSession) Config(_yunToken common.Address) (*types.Transaction, error) {
	return _Dexcontracts.Contract.Config(&_Dexcontracts.TransactOpts, _yunToken)
}

// ExChangeYUN is a paid mutator transaction binding the contract method 0x37ad98d2.
//
// Solidity: function exChangeYUN(_from address, _to address, _value uint256) returns()
func (_Dexcontracts *DexcontractsTransactor) ExChangeYUN(opts *bind.TransactOpts, _from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Dexcontracts.contract.Transact(opts, "exChangeYUN", _from, _to, _value)
}

// ExChangeYUN is a paid mutator transaction binding the contract method 0x37ad98d2.
//
// Solidity: function exChangeYUN(_from address, _to address, _value uint256) returns()
func (_Dexcontracts *DexcontractsSession) ExChangeYUN(_from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Dexcontracts.Contract.ExChangeYUN(&_Dexcontracts.TransactOpts, _from, _to, _value)
}

// ExChangeYUN is a paid mutator transaction binding the contract method 0x37ad98d2.
//
// Solidity: function exChangeYUN(_from address, _to address, _value uint256) returns()
func (_Dexcontracts *DexcontractsTransactorSession) ExChangeYUN(_from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Dexcontracts.Contract.ExChangeYUN(&_Dexcontracts.TransactOpts, _from, _to, _value)
}
